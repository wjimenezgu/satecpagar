...
use backend\models\ReciboSearch;
use backend\models\Model;
use backend\models\Documovidet;
use backend\models\FacturaSearch;
 ...
 */
class ReciboapliController extends Controller
{
    ...
    public function actionIndex()
    {
       // $searchModel = new ReciboSearch();
        ...
        // para desplegar solo documentos tipo recibos y que tengan saldo para aplicar.
        $dataProvider->query->
        
        
         where('Documento.saldo != 0.00
    ...
    public function actionSelfacturas()
    {
    	$searchModel = new FacturaSearch();
    	$dataProvider = $searchModel->search(Yii::$app->request->queryParams);
    
    	return $this->renderAjax('selfacturas', [
    			'searchModel' => $searchModel,
    			'dataProvider' => $dataProvider,
    	]);
    }
