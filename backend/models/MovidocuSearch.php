...
/**
 * MovidocuSearch represents the model behind the search form about `backend\models\Movidocu`.
 */
class MovidocuSearch extends Movidocu
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
      ...
      //      'idCliProCia' => $this->idCliProCia,
        ...
        $query->andFilterWhere(['like', 'numero', $this->numero])
        	...
        	->andFilterWhere(['like', 'TipoDocumento.descripcion', $this->idTipoDocumento])
