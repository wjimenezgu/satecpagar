        ...
        <tbody class="container-items"> <!-- widgetBody -->           
            ...
            <tr class="item">
                <td class="vcenter">
                        ...
                        ?>
                            <div class="col-sm-4">
                            	<?= // $form->field($modelDocumovidet, "[{$i}]numDocAplica")->textInput(['maxlength' => true])
                         		$form->field($modelDocumovidet, "[{$i}]idDocAplica")->dropDownList(
                            			...
                            			['prompt'=>'Seleccione Documento ..',
                            			 'onchange'=>'
				    							$.post("index.php?r=documento/lists&id='.'"+$(this).val(),
    		                   														function (data) {					    																
                            															$("#reciboapli-numero" ).val( data );
				    																});
